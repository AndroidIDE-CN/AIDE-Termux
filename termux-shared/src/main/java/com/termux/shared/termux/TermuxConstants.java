...
public final class TermuxConstants {
	...
	public static final List<String> TERMUX_PLUGIN_APP_NAMES_LIST = Arrays.asList(TERMUX_API_APP_NAME,
			TERMUX_BOOT_APP_NAME, TERMUX_FLOAT_APP_NAME, TERMUX_STYLING_APP_NAME, TERMUX_TASKER_APP_NAME,
			TERMUX_WIDGET_APP_NAME);

	public static final List<String> TERMUX_PLUGIN_APP_PACKAGE_NAMES_LIST = Arrays.asList(TERMUX_API_PACKAGE_NAME,
			TERMUX_BOOT_PACKAGE_NAME, TERMUX_FLOAT_PACKAGE_NAME, TERMUX_STYLING_PACKAGE_NAME,
			TERMUX_TASKER_PACKAGE_NAME, TERMUX_WIDGET_PACKAGE_NAME);
	...
	// Default: "/data/data/com.termux"
	public static final String TERMUX_INTERNAL_PRIVATE_APP_DATA_DIR_PATH;
	...
	public static final List<String> TERMUX_PROPERTIES_FILE_PATHS_LIST = Arrays
			.asList(TERMUX_PROPERTIES_PRIMARY_FILE_PATH, TERMUX_PROPERTIES_SECONDARY_FILE_PATH);
	 ...
	 * modify the values for security properties like {@link #PROP_ALLOW_EXTERNAL_APPS} set by users
	 * without their explicit consent. */
	public static final List<String> TERMUX_FLOAT_PROPERTIES_FILE_PATHS_LIST = Arrays
			.asList(TERMUX_FLOAT_PROPERTIES_PRIMARY_FILE_PATH, TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE_PATH);
	...
	public static final class TERMUX_APP {
		...
		public static final class TERMUX_ACTIVITY {
			...
			public static final String ACTION_NOTIFY_APP_CRASH = TermuxConstants.TERMUX_PACKAGE_NAME_TERMUX
			...
			public static final String ACTION_RELOAD_STYLE = TermuxConstants.TERMUX_PACKAGE_NAME_TERMUX
					+ ".app.reload_style"; // Default: "com.termux.app.reload_style"
	...
	public static final class TERMUX_TASKER {
		...
		public static final String TERMUX_TASKER_ACTIVITY_NAME = TERMUX_TASKER_PACKAGE_NAME
				+ ".activities.TermuxTaskerActivity"; // Default: "com.termux.tasker.activities.TermuxTaskerActivity"
	...
	public static final class TERMUX_WIDGET {
		...
		public static final String TERMUX_WIDGET_ACTIVITY_NAME = TERMUX_WIDGET_PACKAGE_NAME
				+ ".activities.TermuxWidgetActivity"; // Default: "com.termux.widget.activities.TermuxWidgetActivity"
